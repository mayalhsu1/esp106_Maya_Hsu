...
i <- "India" == air$Entity
air_india <- air[i, ]
Outdoor <- air_india$Deaths_Ozone + air_india$Deaths_PM
air_india <- cbind(air_india, Outdoor)

                 
air_germany <- subset(air, Entity == "Germany")
outdoor <- air_germany$Deaths_Ozone + air_germany$Deaths_PM
air_germany <- cbind(air_germany, outdoor)
