...
projected <- merge(temp, weighted_temp, by = "year")

plot(temp$year, temp$mean, ylim = c(0, 27), main = "Projected Annual Global Temperature Trends", xlab = "Year", ylab = "Temperature (Celsius)")
points(weighted_temp$year, weighted_temp$weighted_mean, col = "blue", pch = 1)
legend("topright", legend = c("Temperature Weighted by Population", "Population not Weighted by Population"), col = c("blue", "black"), pch = c(1, 1), cex = 0.75)
